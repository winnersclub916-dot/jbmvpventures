  ...
  return (
    <footer className="w-full border-t border-gray-700 bg-slate-900 text-white">
      <div className="max-w-7xl mx-auto px-6 py-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
        ...
        >
          <Image
            src="/JBMVP%20VENTURES%20logo.jpg"
        ...
        <div className="footer-section">
          ...
          <ul className="space-y-2">
            ...
            <li>
              <a
                // href="mailto:info@WINNERSgroup.com"
                className="text-gray-300 text-sm hover:text-white transition-colors"
              >
                {/* info@WINNERSgroup.com */}
              </a>
            </li>
            <li>
              <span className="text-gray-300 text-sm">
                JBMVP VENTURES LLP FIRST FLOOR, No:18/9 NEAR MARACCANA FOOTBALL
                COURT OLAVANNA POST KOZHIKODE - 673019
              </span>
            </li>
